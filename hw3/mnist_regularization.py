...
def main(args: argparse.Namespace) -> dict[str, float]:
    ...
    # TODO-solved: Incorporate dropout to the model below. Namely, add a `torch.nn.Dropout`
    ...
    # do not add dropout after this output linear layer

    # Wrap the model in the TrainableModule.
    model = npfl138.TrainableModule(model)

    # TODO-solved: Create a `torch.optim.AdamW`, using the default learning rate,
    ...
    # TODO-solved: Implement label smoothing with the given `args.label_smoothing` strength.
