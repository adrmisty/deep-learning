...
def main(args: argparse.Namespace) -> tuple[float, float]:
    """
    Carries out Principal Component analysis computation of
    the covariance matrix of MNIST examples, including:
    ...
    explained_variance : float
        explained variance percentage by the first principal component
    """
    ...
    # TODO-done: Data has shape [args.examples, MNIST.C, MNIST.H, MNIST.W].
    ...
    # TODO-done: Now compute mean of every feature. Use `torch.mean`, and set
    ...
    # TODO-done: Compute the covariance matrix. The covariance matrix is
    ...
    # TODO-done: Compute the total variance, which is the sum of the diagonal
    ...
    # TODO-done: Now run `args.iterations` of the power iteration algorithm.
