...
class Model(npfl138.TrainableModule):
    def __init__(self, args: argparse.Namespace, train: MorphoDataset.Dataset) -> None:
        ...
        RNNLayer = getattr(torch.nn, args.rnn)
        self._word_rnn = RNNLayer(input_size=args.we_dim, hidden_size=args.rnn_dim, bidirectional=True, batch_first=True)
    ...
    def forward(self, word_ids: torch.Tensor) -> torch.Tensor:
        ...
        #hidden = torch.cat([hidden[:, :, :hidden.shape[2]], hidden[:, :, hidden.shape[2]:]], dim=-1)
...
class TrainableDataset(npfl138.TransformedDataset):
    def transform(self, example):  
        # for Debugging:
        #print("Example received:", example)
